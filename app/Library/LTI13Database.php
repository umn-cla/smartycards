...
class LTI13Database implements IDatabase {
    ...
    {
        $query =  \App\Models\LTI13Issuer::where("host", $issuer_url);
    ...
    public function findDeployment($iss, $deployment_id, $client_id = null) {
        ...
        $deployment = \App\Models\LTI13Deployment::where("deployment_id", $deployment_id)->firstOr(function () use($iss, $deployment_id, $client_id) {
            $deployment = new \App\Models\LTI13Deployment;
