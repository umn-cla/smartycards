...
import FoxOwlStudyImgUrl from "@/assets/fox-owl-study.svg";
import ImageDemoCard from "./DemoCards/ImageDemoCard.vue";
...
<style scoped>
.home-page {
  background: linear-gradient(180deg, #600014 0%, #4e1324 6%, #2e091e 35%);
}
</style>
